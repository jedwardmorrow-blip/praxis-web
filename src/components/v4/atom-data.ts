    ...
    nodes: [
      {
        ...
        cat: "Firm",
        desc:
          "Operator-led software firm. Discovery Sprint first, fixed-scope implementation after.",
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        cat: "Co-Founder",
        desc:
          "15-year operator. Four-time founder. Supports client strategy and engagement structure.",
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        kind: "method",
        cat: "Shape 02",
        desc: "Four to six weeks. One operator-grade workflow shipped to production.",
        meta: "Fixed-scope implementation",
        size: 0.26,
        color: "method",
      },
      {
        ...
        kind: "method",
        cat: "Shape 03",
        desc: "Monthly cadence. Continuous improvement after launch.",
        meta: "Available after implementation",
        size: 0.26,
        color: "method",
      },
    ],
